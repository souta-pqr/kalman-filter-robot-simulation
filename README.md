...
詳細な説明は[こちら](https://github.com/souta-pqr/kalman-filter-robot-simulation/blob/main/docs/kalman_filter_theory.ipynb)

ノイズを含む観測値から対象の真の状態を推定する最適フィルタです。ベイズフィルタの一種であり、状態が線形システムに従い、ノイズがガウス分布に従う場合に、最小二乗誤差の意味で最適な推定を行います。
